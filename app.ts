import {Deputy, VerhovnaZrada} from "./classes";
import {Fraction} from "./classes";

let Rabokon = new Deputy(100, 170,'Rabokon','Valera', 48,true, 12350000);
let Vilkul = new Deputy(90, 180,'Vilkul','Oleksandr', 45,true, 3235000000);
let Vakarchuk = new Deputy(78, 176,'Vakarchuk','Slavko', 44,false, 0);
let Skotunyaka = new Deputy(76, 172,'Skotunyaka','TuTaka', 46,true, 500000);

let num:number=1;
switch (num) {
    case 1:
        console.log('1. Verhovna Rada\n 2.Fraction\n 3. Deputy');
        let chooseStructure: number = 2;
    ...
    default:  console.log("Don't have that param");
